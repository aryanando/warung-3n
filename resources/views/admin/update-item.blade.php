            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-12">
                <form action="{{ url('/item/update/'.$item['id']) }}" method="POST">
                                    ...
                                    <div class="mt-2">
                                        <div
                                            ...
                                            <input type="number" name="base_price" id="base_price"
                                                ...
                                                class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                                placeholder="Base Price" value="{{$item['base_price']}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="sm:col-span-4">
                                    ...
                                    <div class="mt-2">
                                        <div
                                            ...
                                            <input type="text" name="unit" id="unit" autocomplete="unit"
                                                class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                                placeholder="Unit" value="{{$item['unit']}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6">
                        <button onclick="window.location.href='{{url('/dashboard')}}';" type="button" class="text-sm font-semibold leading-6 text-gray-900">Cancel</button>
                        <button type="submit"
